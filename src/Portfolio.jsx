...
const PROJECTS = [
  {
    ...
    description:
      "A full-stack platform enabling landlords to list properties and manage tenants, bookings, and payments seamlessly.",
    stack: [
      "Node.js",
      "Express.js",
      "PostgreSQL",
    ...
    features: [
      "Multi-role auth (Landlord/Tenant)",
  ...
  },
  {
    ...
    description:
      "Enterprise-grade HR platform for managing employees, payroll, leave, and attendance with admin dashboard.",
    stack: [
      "Node.js",
      "Express.js",
      "MongoDB",
        ...
        >
          <div style={{ flex: 1, minWidth: 280 }} className="fade-up">
            ...
            >
              ...
              <span style={{ fontSize: 13, color: "#9090A8", fontWeight: 500 }}>
            ...
            >
              ...
              <span style={{ color: "#7DD3FC" }}>secure</span> web applications
          ...
          <div className="hero-avatar" style={{ flexShrink: 0 }}>
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "linear-gradient(135deg, rgba(124,58,237,0.3), rgba(14,165,233,0.3))",
            ...
            >
              <div
                style={{
                  ...
                  height: 240,
                  borderRadius: "50%",
                  background: "linear-gradient(135deg, #1E1030, #0A1628)",
          ...
          >
            <div>
              <p style={{ color: "#9090A8", lineHeight: 1.85, fontSize: 16 }}>
                I'm a MERN Stack Developer with a strong focus on backend
                architecture, building production-ready systems that are fast,
              ...
              >
                My expertise spans REST API design, JWT-based authentication,
                database optimization with PostgreSQL and MongoDB, and deploying
                containerized applications with Docker and AWS.
              </p>
              <p
                style={{
                  color: "#9090A8",
              ...
              >
                I believe great software starts with clean code and a deep
                understanding of the problem at hand — not just writing features
                that work, but architecting systems that last.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Designing systems that grow with your product",
                },
                {
                  icon: "🔐",
                  title: "Security First",
                  desc: "JWT auth, role-based access, and data protection",
                },
                {
                  icon: "⚡",
                  title: "Performance Tuning",
                  desc: "Optimized queries, caching with Redis, efficient APIs",
                },
                {
                  icon: "🤝",
                  title: "Team Collaboration",
                  desc: "Working seamlessly with frontend teams and stakeholders",
                },
              ].map((item) => (
                <div
                  key={item.title}
              ...
              <div key={i} style={{ display: "flex", gap: 28 }}>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      flex: 1,
                      background:
                        "linear-gradient(180deg, #7C3AED33, transparent)",
                      marginTop: 8,
                    }}
                  />
                </div>
                <div style={{ flex: 1, paddingBottom: 48 }}>
                  ...
                  >
                    ...
                    <span style={{ color: "#5050A0", fontSize: 14 }}>
                      📅 {e.period}
                    </span>
                  </div>
                  <div
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: "#6060A0", fontSize: 14 }}>
                  Vinoba Bhave University — Annada College, Hazaribag
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div>
              ...
              >
                ...
                full-time role, freelance project, or just a conversation about
                tech. Drop me a message!
              </p>
              <div
  ...
  {[
    {
      icon: "✉️",
      label: "Email",
      val: "rrkumar7371@email.com",
      href: "mailto:rrkumar7371@email.com",
    },
    {
      icon: "📞",
      label: "Phone",
      val: "+91 73718 05020",
      href: "tel:+917371805020",
    },
    {
      icon: "📍",
      label: "Location",
      val: "Sarita Vihar, Delhi, India",
      href: "https://maps.google.com/?q=Sarita+Vihar+Delhi+India",
    },
    {
      icon: "🔗",
      label: "GitHub",
      val: "github.com/ranjeetkumar",
      href: "https://github.com/rcsharma7371",
    },
    {
      icon: "💼",
      label: "LinkedIn",
      val: "linkedin.com/in/ranjeetkumar",
      href: "https://www.linkedin.com/in/ranjeet-kumar-742b97224/",
    },
  ].map((c) => (
    <a
      key={c.label}
    ...
    >
      ...
      >
        <p style={{ color: "#3030A0", fontSize: 13 }}>
          Designed & built by{" "}
          <span style={{ color: "#7C3AED" }}>Ranjeet Kumar</span> ·{" "}
